package com.architect.zhang.web.webprocess.webviewsetting;
...
import com.architect.zhang.web.BuildConfig;

/**
 * created by zhangxiao on 2020/8/21
 */
public class DefaultWebViewSetting {
    private static DefaultWebViewSetting instance;
    private WebSettings mWebSettings;

    public static DefaultWebViewSetting getInstance() {
        if (instance == null) {
            synchronized (WebSettings.class) {
                instance = new DefaultWebViewSetting();
            }
        }
        return instance;
    }
